...
public class ParserAttribute {
	...
	public boolean equalAttribute(ParserAttribute b){
	...
	public static ParserAttribute parse(String c) throws Exception{
		...
		return new ParserAttribute(split[0].trim(), split[1].trim());
	}
